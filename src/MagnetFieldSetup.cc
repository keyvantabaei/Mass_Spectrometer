...
MagnetFieldSetup::MagnetFieldSetup()
 ...
 // fEquation(0),
  ...
  // fMagneticField(0),
   ...
   Mag_VALUE(1*tesla)
{
  //fMagneticField = new G4UniformMagField(G4ThreeVector(2*tesla,
                                            //           0.0, // 0.5*tesla,
                                                //       0.0));
...
void MagnetFieldSetup::UpdateField()
{
...
//  delete fChordFinder;
 // fChordFinder= nullptr;
  ...
  G4cout<<"MagnetFieldSetup::UpdateField> The minimal step is equal to "
...
void MagnetFieldSetup::CreateSteppers()
{
 // delete fStepper;
  //fStepper= nullptr;
...
void MagnetFieldSetup::SetFieldZValue(G4double fieldStrength)
{
...
void MagnetFieldSetup::SetFieldValue(G4ThreeVector fieldVector)
{
...
void MagnetFieldSetup::SetLocalFieldValue(G4ThreeVector fieldVector)
{
...
//G4FieldManager* MagnetFieldSetup::GetGlobalFieldManager()
//{
...
G4ThreeVector MagnetFieldSetup::GetConstantFieldValue(G4MagneticField* magneticField) const
{
