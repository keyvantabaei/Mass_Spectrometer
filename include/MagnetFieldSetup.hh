...
#ifndef MagnetFieldSetup_h
#define MagnetFieldSetup_h 1
...
class MagnetFieldSetup
{
public:
  MagnetFieldSetup();           //  A zero field
  virtual ~MagnetFieldSetup();
  ...
  G4double GetMagnetZValue(){return Mag_VALUE;}
